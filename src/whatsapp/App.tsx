  ...
  return (
    ...
    >
      ...
      <div className={`${isMobileChatOpen ? 'flex' : 'hidden md:flex'} flex-1 flex flex-row relative w-full h-full bg-[#0b141a] overflow-hidden`}>
        ...
        {showContactProfile && (
          <div className="absolute inset-0 md:static md:inset-auto w-full md:w-[380px] h-full bg-[#111b21] border-l border-[var(--color-wa-border)] flex flex-col z-[60] animate-in slide-in-from-right duration-300">
             {/* Header */}
